...
benchmark_configs = {
	...
	'connect-persona': {
		...
		'replace_legend': {'No Connection': 'NoConnection',
		                   'Max Spanning Unweighted': 'SpanUnweight',
	...
	'compare-other': {
		...
		'replace_legend': {'Ego': 'ES+', 'Ego-original': 'ESF',
		                   'Ego-base': 'ESB'},
		'plots': ['metrics', 'comm_sizes', 'timings', 'num_comms', 'comm_f1'],
		'plot_algo_set': ['all'],
	},
	'test': {
		'result_dir': 'test',
		...
		'replace_legend': {},
		'plots': ['metrics', 'timings', 'ego_net_extend', 'comm_sizes', 'comm_f1'],
		'plot_algo_set': ['Info-local', 'Leiden-local'],
	},
}
