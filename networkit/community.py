...
from _NetworKit import Partition, Coverage, Modularity, CommunityDetector, PLP, LPDegreeOrdered, PLM, PartitionReader, PartitionWriter,\
	...
	CoverF1Similarity, EgoSplitting, LPPotts, OLP, SLPA, OslomCleanUp, SignificanceCommunityCleanUp, LouvainMapEquation, \
	PLMFactory, PLPFactory, LouvainMapEquationFactory
