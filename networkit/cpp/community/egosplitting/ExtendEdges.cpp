...
void ExtendEdges::takeBestCandidates(std::vector<NodeAndScore> &candidatesAndScores) {
...
std::vector<ExtendEdges::NodeAndScore>
ExtendEdges::calculateScores(const std::vector<node> &candidates) const {
...
double ExtendEdges::calculateScore(node v, count numEdges) const {
...
std::vector<node> ExtendEdges::searchForCandidates() {
